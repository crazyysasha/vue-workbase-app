  ...
  <BaseForm @on-submit="onSubmit">
    <template #header>
      <div class="pt-1.5 pb-0.5" v-if="categoryIsLoading">
        <div class="h-7 w-96 bg-primary/10 rounded-lg animate-pulse"></div>
      </div>
    ...
    <ul v-if="servicesIsLoading">
      ...
      >
        <div class="py-1.5 flex gap-2 items-center animate-pulse">
          <div class="rounded-full h-4 w-4 border-8 border-primary/20"></div>
          <div class="pt-1 pb-1">
    ...
    <ul v-else>
      ...
      >
        <label
          class="select-none py-1.5 flex gap-2 items-center cursor-pointer"
        >
          <input
            type="radio"
            class="
      ...
      <li>
        <label
          class="select-none py-0.5 flex gap-2 items-center cursor-pointer"
          @click="newEntry = true"
        >
          <input
            type="radio"
