<template>
    <header class="sticky top-0 z-50 bg-primary text-white">
        <div class="container px-4 sm:px-0 mx-auto flex items-center justify-between">
            <nav v-if="isAuthentificated" class="flex w-full justify-between items-center flex-wrap bg-teal py-4">
                ...
                <button @click="toggle" class="flex items-center text-teal-lighter border-teal-light hover:text-white hover:border-white">
                    <svg class="fill-current h-7 w-7" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384.97 384.97">
                        <g>
                ...
                <div :class="open ? 'block': 'hidden'" class="w-full flex-grow xl:flex xl:items-center xl:w-auto">
