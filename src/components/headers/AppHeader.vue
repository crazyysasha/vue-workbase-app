...
<template>
    <header class="sticky   top-0 z-50 text-white" :class="{
        ...
        <div class="container px-4 2xl:px-20 mx-auto flex items-stretch xl:py-3">
            <div class="flex z-20 py-5 xl:py-0 justify-between w-full xl:w-auto items-center">
                <router-link to="/" class="py-2 mr-12 my-auto w-36 md:w-40">
                    <img v-if="navOpen == true" src="@/assets/logo-white.svg" alt="" class="" />
                    <img v-else :src="
              require(`@/assets/logo${
            ...
            " alt="" class="" />
                ...
                <div class="block xl:hidden">
                    <button v-on:click="navOpen = !navOpen" class="
                            flex
                            text-black
                            items-center
                            text-teal-lighter
                            ...
                            ml-auto
                          ">
                        <svg viewBox="0 0 28 28" class="fill-current text-black h-7 w-7" xmlns="http://www.w3.org/2000/svg" v-if="navOpen = navOpen">
                        ...
                        <svg v-else class="fill-current h-7 w-7" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384.97 384.97">
                            <g>
                                <path d="M12.03,84.212h360.909c6.641,0,12.03-5.39,12.03-12.03c0-6.641-5.39-12.03-12.03-12.03H12.03
                                C5.39,60.152,0,65.541,0,72.182C0,78.823,5.39,84.212,12.03,84.212z" />
                                <path d="M372.939,300.758H12.03c-6.641,0-12.03,5.39-12.03,12.03c0,6.641,5.39,12.03,12.03,12.03h360.909
                                c6.641,0,12.03-5.39,12.03-12.03C384.97,306.147,379.58,300.758,372.939,300.758z" />
                                <path d="M336.848,144.364c-22.4,0-41.059,15.375-46.425,36.091H12.03c-6.641,0-12.03,5.39-12.03,12.03s5.39,12.03,12.03,12.03
            ...
            <nav class="font-medium justify-between items-stretch xl:overflow-hidden overflow-auto block xl:flex bg-primary xl:bg-transparent  absolute xl:static w-10/12 inset-x-0  h-screen xl:h-auto z-10 transition-all duration-300 ease-in-out" v-bind:class="{ 'close': !navOpen }">
              ...
              " :class="{
                ...
                >
                    ...
                    <li>
                        <button @click="showLoginModal = true" type="button" class="
                flex
                items-center
                xl:border
                border-b
              ...
              " :class="{
                ...
                'xl:border-primary xl:hover:bg-primary xl:hover:text-white xl:text-black':
                  headerType == 'primary',
                    ...
                    <li>
                        <button @click="showRegisterModal = true" type="button" class="
                flex
                items-center
                xl:border
                border-b
    ...
    <c-modal v-model="showLoginModal" v-slot="{ close }" v-if="!isAuthentificated">
        <button class="
        absolute
        top-3
        right-3
    ...
    <c-modal v-model="showRegisterModal" v-slot="{ close }" v-if="!isAuthentificated">
        <button class="
        absolute
        top-3
        right-3
