...
<template>
	...
	>
		<marquee
			...
			class="bg-orange-400"
		>
			<span class="text-white">Сервис работает в тестовом режиме!</span>
		</marquee>
		<div
			class="container px-4 2xl:px-20 mx-auto flex items-stretch xl:py-3"
		>
			<div
				class="
					flex
			...
			>
				...
				<div class="block xl:hidden">
					...
					>
                        ...
                        <svg v-if="navOpen" xmlns="http://www.w3.org/2000/svg" class="fill-current text-black h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" />
                        </svg>
                         <svg v-else xmlns="http://www.w3.org/2000/svg" class="fill-current text-black h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
