<template>
    <div class="flex container mx-auto gap-4 py-4">
        <div class="basis-5/7 bg-white shadow-md rounded-lg p-4">
            <div v-show="tabIs('order')">
                <router-view></router-view>
            </div>
            <div v-show="tabIs('specialists')">
                <div>
                    <div class="md:flex">
        ...
        <div class="basis-2/7 flex flex-col">
            <div class="bg-white shadow-md rounded-lg p-4 flex flex-col gap-4">
                <button
                    ...
                    "
                    :class="{
                        'bg-opacity-0 hover:bg-opacity-50': !tabIs('order'),
                        'bg-opacity-75 text-white': tabIs('order'),
                    }"
                >
                    Заказ
                </button>
                <button
                    @click.prevent="changeTab('specialists')"
                    class="
                        block
                        px-4
                        p-2
                    ...
                    :class="{
                        'bg-opacity-0 hover:bg-opacity-50':
                            !tabIs('specialists'),
                        'bg-opacity-75 text-white': tabIs('specialists'),
                    }"
                >
                    Заказ
                </button>
...
const tab = ref(route.query._tab || "order");
const changeTab = (val) => {
    router.replace({ query: { _tab: (tab.value = val) } });
    // router.push()
};
const tabIs = (val) => {
