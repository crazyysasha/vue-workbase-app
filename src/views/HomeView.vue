<template>
        ...
        <div class="container m-auto px-3">
          ...
          >
              <div class="w-full">
                  ...
                  >
                      Как нанять
                      <span class="text-blue-800">специалиста?</span>
                  </h2>
                  <ul>
                      <li class="flex mb-8">
                          <div
                          ...
                          <div class="ml-5">
                              <p
                                  ...
                                  "
                              >
                                  Используя подсказки, опишите работу которую необходимо выполнить для подбора подходящего специалиста.
                                  Процесс заполнения деталей по работе займет не более 10 минут.
                              </p>
                          </div>
                      </li>
                      <li class="flex mb-8">
                          ...
                          <div class="ml-5">
                              <p
                                  ...
                                  "
                              >
                                  Специалисты напишут Вам сами, а Вам только необходимо выбрать того, кто Вам лучше всего подходит и договориться о цене. 
                              </p>
                          </div>
                      </li>
                      <li class="flex mb-8">
                          ...
                          <div class="ml-5">
                              <p
                                  ...
                                  "
                              >
                                  После выполнения работы, не забудьте оставить честный отзыв и оценку выбранному специалисту.
                              </p>
                          </div>
                      </li>
                  </ul>
          ...
          >
              <div class="w-full xl:order-2">
                  ...
                  >
                      Как стать 
                      <span class="text-blue-800">исполнителем?</span>
                  </h2>
                  <ul>
                      <li class="flex mb-8">
                          <div
                          ...
                          <div class="ml-5">
                              <p
                                  ...
                                  "
                              >
                                  Заполните профиль так, чтобы Вам самому захотелось себя нанять. Чем больше информации Вы заполните о себе, тем больше Вам смогут довериться Заказчики.
                              </p>
                          </div>
                      </li>
                      <li class="flex mb-8">
                          ...
                          <div class="ml-5">
                              <p
                                  ...
                                  "
                              >
                                  Выберите задание, которое Вы могли и хотели бы выполнить. Договоритесь с Заказчиком об устраивающей вас цене и условиях выполнения заказа.
                              </p>
                          </div>
                      </li>
                      <li class="flex mb-8">
                          ...
                          <div class="ml-5">
                              <p
                                  ...
                                  "
                              >
                                  После выполнения работы, не забудьте оставить отзыв и оценку выбранному Заказчику.
                              </p>
                          </div>
                      </li>
                  </ul>
              </div>
              <div class="md:w-10/12 w-full xl:order-1 pt-4 md:pt-0">
                  <div class="relative">
                      <img
                          src="../assets/temp/MaskGroup2.png"
                          alt=""
                          class="w-full"
                      />
                  </div>
        ...
        >
            <div class="">
                <h2
                    ...
                    "
                >
                  Теперь все услуги <br>
                  доступны в Вашем кармане <br>
                  с <span class="text-blue-800"> бесплатным мобильным <br> приложением </span>
                  «WorkBase»
    ...
    <footer class="bg-gray-700 py-6 flex w-full items-center justify-center">
        <div class="container px-4 2xl:px-20 mx-auto">
            ...
            >
                <div class="">
                    <h5 class="text-gray-400 text-base xl:text-lg">Компания</h5>
                    <ul>
                        <li
                            class="
                                my-3
